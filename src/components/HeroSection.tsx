...
const HeroSection = () => {
  return (
    <section id="hero" className="relative pt-16 pb-10 md:pt-24 md:pb-14 overflow-hidden">
      <div className="pointer-events-none absolute -top-24 -left-24 h-72 w-72 rounded-full bg-primary/10 blur-3xl md:h-96 md:w-96" aria-hidden="true" />
      <div className="pointer-events-none absolute -top-10 right-0 h-56 w-56 rounded-full bg-primary/[0.06] blur-3xl md:h-80 md:w-80" aria-hidden="true" />
