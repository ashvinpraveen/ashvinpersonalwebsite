...
export default function InviteQrButton({ variant = "nav" }: InviteQrButtonProps) {
  ...
  const dialog =
    open && mounted
      ? createPortal(
          <div
            className="fixed inset-0 z-[200] flex items-center justify-center bg-[#0d281c]/55 px-4 py-8 backdrop-blur-[3px]"
            role="dialog"
            aria-modal="true"
          ...
          >
            <div
              className="w-full max-w-sm rounded-[28px] border border-white/50 bg-[color:var(--run-panel)] p-5 shadow-[0_24px_80px_rgba(12,40,28,0.35)]"
